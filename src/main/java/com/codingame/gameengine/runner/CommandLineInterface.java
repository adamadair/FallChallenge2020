    ...
    public static void main(String[] args) {
        try {
            ...
            options.addOption("h", false, "Print the help")
                    ...
                    .addOption("n1", true, "Player 1 nickname")
                    .addOption("n2", true, "Player 2 nickname")
            ...
            for (int i = 1; i <= 2; ++i) {
                if (cmd.hasOption("p" + i)) {
                    String command = cmd.getOptionValue("p" + i);
                    String nick = cmd.hasOption("n" + i) ? cmd.getOptionValue("n" + i) : command;
                    runner.addAgent(command, nick);
                    playerCount += 1;
                }
            }
            ...
            if (cmd.hasOption("s")) {
                ...
                for (int i = 0; i < playerCount; ++i) {
                    System.out.println(runner.gameResult.scores.get(i));
                }

                for (String line : runner.gameResult.uinput) {
